// горизонтальный/вертикальный градиент
...
int main() {
	...
	width = 600; ggggg.write((char*)&width, 4);
	height = 600; ggggg.write((char*)&height, 4);
	...
	c.R = (float)R1; c.G = (float)G1; c.B = (float)B1;
	t.R = (float)R1; t.G = (float)G1; t.B = (float)B1;
